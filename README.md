...
- [x] Vorstand in `src/data/vorstand.ts`: 1. Vorsitzender Erich Könneke,
      2. Vorsitzender Uwe Speer, Schriftführerin Monika Koch
- [ ] Name des Kassenwarts fehlt noch – die Stelle steht mit „Name folgt" in
      der Liste
