...
/**
 * REFERENZ – nicht auf der Website eingebunden.
 *
 * Wortlaut der Datenschutzerklärung, wie sie auf https://vsv-roessing.de/
 * steht. Bleibt hier als Vergleichsgrundlage liegen, damit beim Umzug in die
 * Originalumgebung nachvollziehbar ist, was ersetzt wurde. Ausgeliefert wird
 * stattdessen datenschutz.ts.
 *
